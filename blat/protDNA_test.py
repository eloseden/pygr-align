...
class Blat_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.protDNAaln = True  # if protein-dna alignment- True,else- False     
...
class Blat_NLMSA_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.destDB = translationDB.get_translation_db(self.destDB)
    ...
    def test_align_manual1(self):
        ...
        s3 = self.destDB.annodb['gi|171854975|dbj|AB364477.1|:0']
    ...
    def test_align_auto1(self):
        ...
        for s2grp in s2_group:
            ...
            frame_no = s2grp[1]%3 
            s2 = self.destDB.annodb[s2grp[0]+":"+str(frame_no)]
